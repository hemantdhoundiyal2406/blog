...
<body style="background: -webkit-linear-gradient(to bottom right, #c31432, #240b36); background: linear-gradient(to bottom right, #c31432, #240b36); padding: 20px;">
    <div style="width: 70%;margin: 20px auto;padding: 20px;background: #FFF;text-align: center; border-radius: 10px;">
        ...
        <p style="font-size: 12px;">To go to the website and log in, click the button below.</p>

        <a href="{{ route('login') }}" class="button" style="background-color: #3498db;border-radius: 10px;color: white;padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;margin: 4px 2px;cursor: pointer;">Go to website</a>
    </div>
</body>
</html>